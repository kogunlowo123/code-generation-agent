"""Code Generation Agent - Main Agent Implementation."""
...
class CodeGenerationAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.spec_to_code_enabled = True
        self.schema_generation_enabled = True
        self.api_scaffolding_enabled = True
        self.fullstack_features_enabled = True
        self.migration_generation_enabled = True
        self._tool_dispatch = {
            "generate_from_spec": self.tools.generate_from_spec,
            "generate_api_endpoint": self.tools.generate_api_endpoint,
            "generate_database_schema": self.tools.generate_database_schema,
            "generate_crud": self.tools.generate_crud,
            "generate_frontend_component": self.tools.generate_frontend_component,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['spec_to_code', 'schema_generation', 'api_scaffolding', 'fullstack_features', 'migration_generation'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "generate_from_spec": ['generate', 'from', 'spec'],
            "generate_api_endpoint": ['generate', 'api', 'endpoint'],
            "generate_database_schema": ['generate', 'database', 'schema'],
            "generate_crud": ['generate', 'crud'],
            "generate_frontend_component": ['generate', 'frontend', 'component'],
        }
